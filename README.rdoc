...
Instead of installing Day Care Ops locally go to daycareops.herokuapp.com to demo the app by using the following credentials for all logins: richard.messing@gmail.com | password: 12345678.
